...
CREATE TABLE IF NOT EXISTS `myaac_lua_monsters` (`id` INT NOT NULL AUTO_INCREMENT,`name` VARCHAR(255) NOT NULL,`mana` INT NOT NULL DEFAULT 0,`exp` INT NOT NULL DEFAULT 0,`health` INT NOT NULL DEFAULT 0,`bestiary_class` VARCHAR(100) NOT NULL DEFAULT '',`bosstiary_class` VARCHAR(20) NOT NULL DEFAULT '',`outfit` VARCHAR(255) NOT NULL DEFAULT '',`speed_lvl` INT NOT NULL DEFAULT 1,`use_haste` TINYINT NOT NULL DEFAULT 0,`summonable` TINYINT NOT NULL DEFAULT 0,`convinceable` TINYINT NOT NULL DEFAULT 0,`rewardboss` TINYINT NOT NULL DEFAULT 0,`voices` VARCHAR(3000) NOT NULL DEFAULT '',`immunities` VARCHAR(255) NOT NULL DEFAULT '',`elements` VARCHAR(1000) NOT NULL DEFAULT '',`defense` INT NOT NULL DEFAULT 0,`armor` INT NOT NULL DEFAULT 0,`race` VARCHAR(255) NOT NULL DEFAULT '',`loot` VARCHAR(5000) NOT NULL DEFAULT '',`summons` VARCHAR(1000) NOT NULL DEFAULT '',`flags` VARCHAR(1000) NOT NULL DEFAULT '',`hide` TINYINT NOT NULL DEFAULT 0,PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `myaac_menu` (`template`,`name`,`link`,`access`,`blank`,`color`,`category`,`ordering`,`enabled`)
SELECT 'canary','Spells','spells',0,0,'',5,4,1 FROM DUAL
